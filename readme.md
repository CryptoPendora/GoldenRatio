...
ส่วนนี้ของโค้ดตั้งค่าความแม่นยำสำหรับการคำนวณเป็น 10000 บิต เพื่อให้ได้ค่า Golden Ratio ที่แม่นยำมากขึ้น สำหรับ สำหรับ 1ล้านเลข ใช้เวลาประมาณ 20-30 วินาที (	AMD Ryzen 5 Ram 32GB  )
